...
Dialogue portraits are dedicated head-and-shoulders images: `portrait-liv.png` is cropped from the concept, `portrait-nadja.png` was generated by Codex with the Liv crop as style reference. The full-body atlas is only used for the intro avatar cards now. Patrik rejected atlas crops as portraits on 2026-08-27 (neck-cropped, odd framing); any new speaker needs a portrait made the same way.
